...
router.put('/products/:id', async (req, res) => {
  console.log('≡ƒÄ» PUT /admin/products/:id route HIT!');
  console.log('≡ƒåö Product ID:', req.params.id);
  console.log('≡ƒôª Request body:', JSON.stringify(req.body, null, 2));
  console.log('≡ƒöæ Authorization header:', req.headers.authorization ? 'present' : 'missing');
  ...
  try {
    ...
    console.log('≡ƒô¥ Updating product ID:', req.params.id);
    console.log('≡ƒôª Received data:', {
      name,
      price,
      stock,
      has_magsafe_option,
    ...
    if (price_without_magsafe !== undefined && price_without_magsafe !== null) {
      ...
      console.log('Γ£à Updating price_without_magsafe to:', price_without_magsafe);
    }
    if (price_with_magsafe !== undefined && price_with_magsafe !== null) {
      updates.push('price_with_magsafe = ?');
      params.push(price_with_magsafe);
      console.log('Γ£à Updating price_with_magsafe to:', price_with_magsafe);
    }
    ...
    console.log('≡ƒöä SQL Query:', `UPDATE products SET ${updates.join(', ')} WHERE id = ?`);
    console.log('≡ƒöä Params:', params);
    ...
    console.log('Γ£à Product updated successfully');
    res.json({ message: 'Product updated successfully' });
  } catch (error) {
    console.error('Γ¥î Error updating product:', error);
